...
# to keep track of the machine type of TLCS900 object files
...
if [ x"${EMULATION_NAME}" = x"elf32tlcs900" ]; then
  fragment <<EOF
...
LDEMUL_AFTER_OPEN=tlcs900_after_open
