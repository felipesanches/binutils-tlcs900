...
opc_main[] =
{
  ...
  { 0x06, 0xff, prt_n,       "ei %02x", INSS_ALL },
  { 0x07, 0xff, prt,         "reti", INSS_ALL },
  { 0x08, 0xff, prt_n_n,     "ld (%02x), %%02x", INSS_ALL },
  { 0x09, 0xff, prt_n,       "push %02x", INSS_ALL },
  { 0x0a, 0xff, prt_n_nn,    "ldw (%02x), %%04x", INSS_ALL },
  { 0x0b, 0xff, prt_nn,      "pushw %%04x", INSS_ALL },
  { 0x0c, 0xff, prt,         "incf", INSS_ALL },
  { 0x0d, 0xff, prt,         "decf", INSS_ALL },
  { 0x0e, 0xff, prt,         "ret", INSS_ALL },
  { 0x0f, 0xff, prt_nn,      "retd %%04x", INSS_ALL },
  ...
  { 0x17, 0xff, prt_n,       "ldf %02x", INSS_ALL },
  { 0x18, 0xff, prt,         "push f", INSS_ALL },
  { 0x19, 0xff, prt,         "pop f", INSS_ALL },
  { 0x1a, 0xff, prt_nn,      "jp %04x", INSS_ALL },
  { 0x1b, 0xff, prt_nnn,     "jp %06x", INSS_ALL },
  { 0x1c, 0xff, prt_nn,      "call %04x", INSS_ALL },
  { 0x1d, 0xff, prt_nnn,     "call %06x", INSS_ALL },
  { 0x1e, 0xff, prt_nn,      "calr PC + %04x", INSS_ALL },
  { 0x20, 0xf8, prt_r_n,     "ld %s, %02x", INSS_ALL },
  { 0x28, 0xf8, prt_rr,      "push %s", INSS_ALL },
  { 0x30, 0xf8, prt_rr_nn,   "ld %s, %04x", INSS_ALL },
  { 0x38, 0xf8, prt_xrr,     "push %s", INSS_ALL },
  { 0x40, 0xf8, prt_xrr_nnn, "ld %s, %06x", INSS_ALL },
  { 0x48, 0xf8, pop_rr,      "pop %s", INSS_ALL },
  { 0x58, 0xf8, prt_xrr,     "pop %s", INSS_ALL },
  { 0x60, 0xF0, prt_cc_n,    "jr %s, PC + %02x", INSS_ALL },
  { 0x70, 0xF0, prt_cc_nn,   "jrl %s, PC + %04x", INSS_ALL },
...
/* TODO:
  { 0xc0, 0xff, prt,       "", INSS_ALL },
  { 0xc1, 0xff, prt,       "", INSS_ALL },
  { 0xc2, 0xff, prt,       "", INSS_ALL },
  { 0xc3, 0xff, prt,       "", INSS_ALL },
  { 0xc4, 0xff, prt,       "", INSS_ALL },
  { 0xc5, 0xff, prt,       "", INSS_ALL },
  { 0xc7, 0xff, prt,       "", INSS_ALL },
  { 0xc8, 0xf8, prt,       "", INSS_ALL },
  { 0xd0, 0xff, prt,       "", INSS_ALL },
  { 0xd1, 0xff, prt,       "", INSS_ALL },
  { 0xd2, 0xff, prt,       "", INSS_ALL },
  { 0xd3, 0xff, prt,       "", INSS_ALL },
  { 0xd4, 0xff, prt,       "", INSS_ALL },
  { 0xd5, 0xff, prt,       "", INSS_ALL },
  { 0xd7, 0xff, prt,       "", INSS_ALL },
  { 0xd8, 0xf8, prt,       "", INSS_ALL },
  { 0xe0, 0xff, prt,       "", INSS_ALL },
  { 0xe1, 0xff, prt,       "", INSS_ALL },
  { 0xe2, 0xff, prt,       "", INSS_ALL },
  { 0xe3, 0xff, prt,       "", INSS_ALL },
  { 0xe4, 0xff, prt,       "", INSS_ALL },
  { 0xe5, 0xff, prt,       "", INSS_ALL },
  { 0xe7, 0xff, prt,       "", INSS_ALL },
  { 0xe8, 0xf8, prt,       "", INSS_ALL },
  { 0xf0, 0xff, prt,       "", INSS_ALL },
  { 0xf1, 0xff, prt,       "", INSS_ALL },
  { 0xf2, 0xff, prt,       "", INSS_ALL },
  { 0xf3, 0xff, prt,       "", INSS_ALL },
  { 0xf4, 0xff, prt,       "", INSS_ALL },
  { 0xf5, 0xff, prt,       "", INSS_ALL },
  { 0xf7, 0xff, prt,       "", INSS_ALL },
  { 0xf8, 0xf8, prt,       "", INSS_ALL }
  */
} ;
